...
public class StorageService {
    ...
    private final static String STORAGE_PATH = "/var/classroom/";
    private final static String POSTS_DIR = "posts", ASSIGNMENT_DIR = "assignment", SUBMISSION_DIR = "submission";
    ...
    private String getDirByType(int type){
        if ( type == 0)
            return POSTS_DIR;
        else if ( type == 1 )
